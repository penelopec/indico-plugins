...
class ZoomExtension(db.Model):
    __tablename__ = 'zoom_extensions'
    ...
    def join_url(self):
        ...
        custom_url_tpl = ZoomPlugin.settings.get('client_chooser_url')
        if custom_url_tpl:
    ...
    @return_ascii
    def __repr__(self):
        return '<ZoomExtension({}, {}, {})>'.format(self.vc_room, self.extension, self.owned_by_user)


@listens_for(ZoomExtension.owned_by_user, 'set')
